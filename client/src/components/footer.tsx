        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pl-6 md:pl-0">
          ...
          <div className="space-y-4 text-left">
            ...
            <div className="text-sm text-gray-300 space-y-1">
              ...
              <p>
                <a href="mailto:honza@pujcovnaoutdooru.cz" className="hover:text-white transition-colors">
                  honza@pujcovnaoutdooru.cz
                </a>
              </p>
              <p>
                <a href="tel:+420734415950" className="hover:text-white transition-colors">
                  +420 734 415 950
                </a>
              </p>
            </div>
